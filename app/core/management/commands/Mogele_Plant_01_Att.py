...
ip_one = ZK(env('PLANT_01_ATT'), port=4370) #172.16.32.81 head office ip
conn_one = None
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        self.stdout.write("Plant 01 attendance : server running")
        try:
            conn_one = ip_one.connect()
            print('------------Plant 01 attendance : Device connected!!------------')
            ...
            for attendance in conn_one.live_capture():
                if attendance is None:
                    ...
                    file_name = 'plant_01_att_'+today_date_split[0]+'_' + \
                    ...
                    with open('paylodad.json', 'w') as jsonfile:
                    ...
                    print("------------Plant 01 attendance : Punch detected------------")
        except UnboundLocalError:
            print(" Plant 01 attendance : I am unable to connect to server")
        except Exception as e:
            print("Plant 01 attendance : Process terminate : {}".format(e))
        finally:
            if conn_one:
                conn_one.disconnect()
